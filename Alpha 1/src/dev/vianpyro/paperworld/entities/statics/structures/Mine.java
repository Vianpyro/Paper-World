...
public class Mine extends StaticEntity {
	...
	public Mine(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.mine, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	}
}
