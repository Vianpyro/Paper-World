...
public class Port extends StaticEntity {

	public Port(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.port, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
	}
}
